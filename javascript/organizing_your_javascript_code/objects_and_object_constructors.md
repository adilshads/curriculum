...
/** I believe the following 2 bullets from the additional resources section would be better suited in the assingments section. Until I went through the following 2 bullets, I did not have a firm grasp of the concepts. */
...
3. You might have noticed us using the `this` keyword in object constructors and prototype methods in the examples above.
